...
import { AlertTriangle, Check, FileCheck2, Gauge, LayoutGrid, List, Plus, Trash2, X } from 'lucide-react'
...
export function SkillsPage() {
  ...
  const [addMethod, setAddMethod] = useState<'ai-assess' | 'ai-estimate'>('ai-assess')
